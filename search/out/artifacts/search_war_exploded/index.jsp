  ...
  <div class="panel panel-default pre-scrollable">
    <div class="panel-heading">
      ...
      <div class="form-group">
        <span>
          <input class="in" type="text" class="form-control " placeholder="请输入商品货号">
          <input class="in" type="text" class="form-control " placeholder="请输入条形码">
        </span>
